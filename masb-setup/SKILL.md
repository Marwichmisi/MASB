---
name: "masb-setup"
description: Sets up Marwane Android Spec Builder module in a project. Use when the user requests to 'install masb module', 'configure Marwane Android Spec Builder', or 'setup Marwane Android Spec Builder'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/masb/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code masb
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code masb --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
